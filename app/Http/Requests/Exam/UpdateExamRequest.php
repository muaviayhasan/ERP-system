...
class UpdateExamRequest extends FormRequest
{
    ...
    {
        $id = $this->route('exam')?->id ?? $this->route('exam');

        return [
            'name' => ['sometimes', 'required', 'string', 'max:255'],
            'code' => ['nullable', 'string', 'max:255', Rule::unique('exams', 'code')->ignore($id)],
            'exam_type' => ['sometimes', 'required', 'in:Final,Midterm,Quiz,Practical,Supplementary,Annual'],
